...
export const datasetsPipelines = [
  {
        ...
        fields: [
          {
            typeOfComponent: 'DataSetsPipeline',
            nameOfComponent: 'dataSetsPipeline',
            inputFieldName: 'defaultOperator',
            isOptional: false,
            directInput: false,
            formInput: '',
            formInputType: 'String',
    ...
    sampleSchema: {
      type: 'object',
      properties: {
        defaultOperator: { type: 'string', required: true },
        defaultType: { type: 'string', required: true },
        defaultPortal: { type: 'string', required: true },
